defmodule LvFieldErrorsWeb.LinkLive.Index do
  use LvFieldErrorsWeb, :live_view
  ...
  @impl true
  def handle_info({LvFieldErrorsWeb.LinkLive.FormComponent, {:saved, link}}, socket) do
